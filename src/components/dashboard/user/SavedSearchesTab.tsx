...
import { Trash, Search, Home, Tag, AlertCircle } from 'lucide-react';
...
const SavedSearchesTab = () => {
  ...
  const confirmDelete = () => {
    if (selectedSearchId) {
      deleteMutation.mutate(selectedSearchId);
    }
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button 
                        ...
                        onClick={() => handleDeleteClick(search._id)}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor={`notify-${search._id}`} className="flex items-center">
